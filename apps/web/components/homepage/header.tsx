...
// Replaced Radix   with plain div-based menu for mobile ΓÇö no external sheet import
import {
  Collapsible,
  CollapsibleContent,
  CollapsibleTrigger,
} from '@workspace/ui/components/collapsible';
// DialogTitle removed ΓÇö menu now renders client-side only
...
const MOBILE_MENU_GROUPS = [
  {
    ...
    links: [
      ...
      },
      {
        ...
        description: 'Discover the story behind ARIIAΓÇÖs name its vision for the future.',
      ...
      },
      {
        href: '/contact-us/',
        label: 'Contact Us',
        description: 'Have questions? Reach out, and weΓÇÖll respond within 24 hours.',
